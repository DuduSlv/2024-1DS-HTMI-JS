...
('Quesia Oliveira', 'quesia.oliveira@gmail.com', '81987654337'),
...
('Promocao "Sobremesa Completa": Na compra de um sundae, leve uma cobertura de chocolate gratis', '2025-07-15', '2025-07-31', 0.00, 'Sundae de baunilha ou chocolate'),
('Happy Hour Gelado: Sorvetes a 50% de desconto das 15h às 17h', '2025-08-01', '2025-08-31', 50.00, 'Sorvetes de 500ml (qualquer sabor)'),
('Festa de Sorvete: Ao fazer qualquer festa de aniversario no local, ganhe um sorvete extra para todos os convidados', '2025-06-01', '2025-06-30', 0.00, 'Todos os sabores de sorvetes'),
('Sabado de Ofertas: Desconto de 20% em todos os sorvetes aos sabados', '2025-05-01', '2025-05-30', 20.00, 'Todos os sorvetes'),
('Combo Familia: Compre 4 potes de sorvete e ganhe um pacote de wafer gratis', '2025-10-01', '2025-10-15', 0.00, 'Sorvetes de chocolate, baunilha, morango e limao'),
('Dia das Maes Especial: Na compra de dois sorvetes de 500ml, ganhe um mini sundae para sua mae', '2025-05-01', '2025-05-10', 0.00, 'Sorvetes de 500ml (qualquer sabor)'),
('Promocao da Amizade: Traga um amigo e ganhe 20% de desconto no seu pedido', '2025-06-01', '2025-06-10', 20.00, 'Qualquer sorvete ou sundae'),
...
('Promocao do Dia das Criancas: As criancas ate 12 anos ganham um sorvete gratis no dia 12 de outubro', '2025-10-12', '2025-10-12', 100.00, 'Mini sorvetes de creme e chocolate'),
('Sorvete na Taça: Ao pedir qualquer taça de sorvete, ganhe uma fatia de bolo de chocolate gratis', '2025-09-01', '2025-09-15', 0.00, 'Tacas de sorvete'),
...
('Promocao Cafe Gelado: Ganhe 10% de desconto no seu sorvete de cafe ao pedir uma bebida gelada no cardapio', '2025-08-01', '2025-08-31', 10.00, 'Sorvete de cafe'),
('Festival de Sorvetes: Desconto de 30% nos sorvetes de 1 litro durante o mes de julho', '2025-07-01', '2025-07-31', 30.00, 'Sorvetes de 1L (qualquer sabor)'),
('Combo Dia dos Namorados: Na compra de dois sorvetes de 500ml, ganhe uma taca de vidro exclusiva', '2025-06-01', '2025-06-12', 0.00, 'Sorvetes de 500ml (sabor a escolha)'),
('Promocao do Dia do Sorvete: Em comemoracao ao Dia do Sorvete, todos os sorvetes terao 20% de desconto', '2025-09-23', '2025-09-23', 20.00, 'Todos os sorvetes'),
('Adoce seu Natal: Ganhe um mini panetone gratis ao comprar qualquer combo de sorvetes no mes de dezembro', '2025-12-01', '2025-12-25', 0.00, 'Combos de sorvete (qualquer sabor)'),
('Promocao de Inverno: Sorvetes de chocolate quente com 20% de desconto durante o inverno', '2025-06-01', '2025-08-31', 20.00, 'Sorvete de chocolate quente');
