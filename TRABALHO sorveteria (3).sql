...
('Tiago Costa', 'tiago.costa@gmail.com', '21987654340');
  ...
  freezer ENUM('cheio', 'vazio'));
    ...
    INSERT INTO sorveteria (nome_funcionario, cargo_funcionarios) VALUES ('Ana Silva', 'Atendente'), ('Bruno Costa', 'Gerente'), ('Carla Lima', 'Sorveteiro'), ('Daniel Souza', 'Atendente'), ('Eduarda Pereira', 'Gerente de Estoque'), ('Felipe Almeida', 'Sorveteiro'), ('Gabriela Santos', 'Atendente'), ('Henrique Oliveira', 'Gerente'), ('Isabela Rocha', 'Sorveteiro'), ('João Pedro', 'Atendente'), ('Larissa Martins', 'Sorveteiro'), ('Matheus Lima', 'Gerente de Operacoes'), ('Natalia Costa', 'Atendente'), ('Otavio Silva', 'Sorveteiro'), ('Priscila Fernandes', 'Atendente'), ('Quentin Souza', 'Gerente de Vendas'), ('Rafaela Gomes', 'Sorveteiro'), ('Samuel Pereira', 'Atendente'), ('Thais Barbosa', 'Gerente'), ('Vinicius Rocha', 'Sorveteiro');
